								...
								<div class="col-lg-12">
									<div class="mb-3">
										...
										<ul class="list-unstyled fruite-categorie">
											...
											<li>
												<div class="d-flex justify-content-between fruite-name">
													<a href="creator-class" class="h5"><i class="fas fa-apple-alt me-2"></i>클래스</a>
													<span>(5)</span>
												</div>
											</li>
											<li>
												<div class="d-flex justify-content-between fruite-name">
													<a href="creator-review" class="h5"><i class="fas fa-apple-alt me-2"></i>후기관리</a>
													<span>(5)</span>
												</div>
											</li>
											<li>
												<div class="d-flex justify-content-between fruite-name">
													<a href="creator-analyze" class="h5"><i class="fas fa-apple-alt me-2"></i>클래스분석</a>
													<span>(2)</span>
												</div>
											</li>
											<li>
