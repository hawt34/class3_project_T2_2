	                	...
	                	<c:forEach var="contents" items="${top10List}">
							...
							<div class="rounded position-relative vesitable-item" style="width: 306px;">
								<div class="vesitable-img">
									<img src="${pageContext.request.contextPath}/resources/upload/${classItem.class_thumnail} class="img-fluid w-100 rounded-top classPic" onclick="location.href='class-detail?class_code=${contents.class_code}'">
								</div>
									...
									<div class="col-md-6 col-lg-4 col-xl-3" style="width: 330px;">
										<div class="rounded position-relative class-item classCard">
											<div class="">
												...
												<img src="${pageContext.request.contextPath}/resources/upload/${classItem.class_thumnail} onclick="location.href='class-detail?class_code=${contents.class_code}'">
												<!-- like class 하트 여부-->
												<c:choose>
