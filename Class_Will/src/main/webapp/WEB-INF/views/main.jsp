...
<!--                     </div> -->
        ...
        <!-- chatbot -->
        <a href="#" class="btn btn-primary border-3 border-primary rounded-circle chatbot"><img src="${pageContext.request.contextPath}/resources/img/chatbot.png" width="100px" alt="chatbot" ></a>   
